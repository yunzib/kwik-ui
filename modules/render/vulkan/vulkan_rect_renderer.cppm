...
public:
    ...
    void fillRoundedRect(VulkanContext &ctx, const Rect &rect,
                         float radius, const Color &color, float globalAlpha);
    void strokeRoundedRect(VulkanContext &ctx, const Rect &rect, float radius,
                           const Color &color, float strokeWidth, float globalAlpha);
    void drawShadow(VulkanContext &ctx, const Rect &rect,
                    float radius, const Shadow &shadow, float globalAlpha);
