// ============================================================================
// binding.cppm — 状态绑定抽象接口
//
// 组件层通过此接口与 JS 引擎解耦。
// 组件只调用 setBool/setString/setFloat，不包含任何 QuickJS 相关代码。
// 具体实现（JSStateBinding）在引擎层 kwik.engine.state_binding 完成。
//
// 历史: 本接口原声明于 kwik.engine.state_binding,
//       为解除 element → engine 依赖而下移至 core (L0 层, 双向可达无环)。
// ============================================================================

export module kwik.core.binding;
